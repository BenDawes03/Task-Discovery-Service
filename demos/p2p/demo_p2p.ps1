...
$nodeBCommand = "`$env:TDS_PROXY_LISTEN=':5101'; & '.\\bin\\client_proxy.exe' -p2p -p2p-port :6001 -bootstrap localhost:6000 -k-closest $KClosest"
...
$nodeCCommand = "`$env:TDS_PROXY_LISTEN=':5102'; & '.\\bin\\client_proxy.exe' -p2p -p2p-port :6002 -bootstrap localhost:6000 -k-closest $KClosest"
