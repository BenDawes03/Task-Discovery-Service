...
### 2. **Launcher Scripts**
- **`demos/interactive/run_demo.ps1`** - Launches just the demo (checks for server)
- **`demos/interactive/demo_all_in_one.ps1`** - Starts server AND demo automatically (easiest option!)

### 3. **Documentation**
- **`demos/interactive/README.md`** - Technical details and customization options
- **`demos/interactive/PRESENTATION_GUIDE.md`** - Complete presentation script with timing
...
.\demos\interactive\demo_all_in_one.ps1
```
...
See [demos/interactive/PRESENTATION_GUIDE.md](PRESENTATION_GUIDE.md) for the moved copy of that guide.
...
4. Use `demos/interactive/demo_all_in_one.ps1` which handles this automatically
