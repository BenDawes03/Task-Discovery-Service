...
Write-Host "  .\client_demo.exe -mode p2p -server localhost:5100" -ForegroundColor White
Write-Host "  .\client_demo.exe -mode p2p -server localhost:5101" -ForegroundColor White
